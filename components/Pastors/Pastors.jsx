        ...
        <div className='flex flex-col gap-16 mb-12 flex flex-col px-4 md:px-10 mt-28 lg:px-16 w-full items-center gap-[40px]'>
            <div className='flex items-center w-full justify-between'>
                <div className='flex flex-col gap-6'>
                    ...
                    <p className='text-[#000000] text-[24px] font-normal'>
                ...
                <Image src="/state.svg" alt="Pastors" width={643} height={400} className='' />
            </div>
            <div className="py-8 w-full flex flex-col items-center justify-center gap-[40px]">
                ...
                <Image src="/gather.svg" alt="Pastors" width={643} height={400} className='w-full' />
            </div>
        </div>
    )
}
